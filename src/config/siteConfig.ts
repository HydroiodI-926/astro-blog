...
export const siteConfig: SiteConfig = {
	title: "Hydroiody的博客",
	subtitle: "Hydroiody的临时小站",
	siteURL: "https://HydroiodI-926.github.io/astro-blog/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-07-23", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "453418403", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
